import { DEVIT_INIT_STATE } from './../context/AppContext';
import { IComment, IDevit } from '../interfaces';

export type ActionType = 
  | {type: 'LOAD DEVITS', payload: string}
...
export const devitReducer = (state: IDevit[] = DEVIT_INIT_STATE, action: ActionType): IDevit[] => {
  switch (action.type) {
  case 'LOAD DEVITS':
    return [
      ...action.payload
